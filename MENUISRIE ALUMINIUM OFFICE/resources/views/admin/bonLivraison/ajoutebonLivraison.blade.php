<!-- Modal -->
        <div class="modal fade" id="addBonLivraison" tabindex="-1" role="dialog" aria-labelledby="addNewLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" v-show="!editmode" id="addNewLabel">Ajouter un nouveau bon de livraison</h4>
                   
                </div>
                <form action="bonLivraisons/" method="POST" >
                     {{csrf_field()}}
                <div class="modal-body">
                     <div class="form-group">
                        <input  type="text" name="id"  required="id" 
                            placeholder="Code de bon de livraison"
                            class="form-control"  >
