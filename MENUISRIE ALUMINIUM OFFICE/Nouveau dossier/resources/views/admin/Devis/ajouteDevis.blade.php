<!-- Modal -->
        <div class="modal fade" id="adddevi" tabindex="-1" role="dialog" aria-labelledby="addNewLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" v-show="!editmode" id="addNewLabel">Ajouter un nouveau devis</h4>
                   
                </div>
                <form action="Devi/" method="POST" >
                     {{csrf_field()}}
                <div class="modal-body">
                     <div class="form-group">
                        <input  type="text" name="id"  required="id" 
                            placeholder="Code de Devi"
                            class="form-control"  >
