        ...
        <div class="modal fade" id="addProduit" tabindex="-1" role="dialog" aria-labelledby="addNewLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" v-show="!editmode" id="addNewLabel">Ajouter un autre produit au Facture {{$factures->id}}</h4>
                   
                </div>
                <form action="" method="POST" >
                     {{csrf_field()}}
                <div class="modal-body">
                    <input type="hidden" name="id_facture" value="{{$factures->id}}">
